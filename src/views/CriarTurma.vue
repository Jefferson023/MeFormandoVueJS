      ...
      <b-col md="12">
        <b-card>
          ...
          <b-form>
            ...
            <b-form-group label="Instituição" label-for="Instituicao" :label-cols="3">
              <b-form-input id="Instituicao" v-model="Instituicao" type="text"></b-form-input>
            </b-form-group>
            <b-form-group label="Ano de Formação" label-for="AnoFormacao" :label-cols="3">
              <b-form-input id="AnoFormacao" v-model="AnoFormacao" type="number"></b-form-input>
            </b-form-group>
            <b-form-group label="Semestre de Formação" label-for="SemestreFormacao" :label-cols="3">
              <b-form-input id="SemestreFormacao" v-model="SemestreFormacao" type="number"></b-form-input>
            </b-form-group>
            <b-form-group label="Curso" label-for="Curso" :label-cols="3">
    ...
    criarTurma() {
      if (
        ...
        const data = qs.stringify({
          ...
          AnoFormacao: this.AnoFormacao,
          SemestreFormacao: this.SemestreFormacao,
          Curso: this.Curso
        });
        ...
        axios
          .post(process.env.VUE_APP_API + "/turma/criar", data, {headers:{"content-type": "application/x-www-form-urlencoded;charset=utf-8",
          'token': localStorage.getItem("user_token")}})
          .then(response => {
