      ...
      <b-col md="12">
        <b-card>
          ...
          <b-form>
            ...
            <b-form-group label="Ganho" label-for="ganho" :label-cols="3">
              <b-form-input
                id="Ganho"
                v-model="Ganho"
                type="number"
            ...
            <b-form-group label="Data Inicial" label-for="dInicial" :label-cols="3">
              <b-form-input id="dInicial" v-model="dInicial" type="date"></b-form-input>
            </b-form-group>

            <b-form-group label="Data Final" label-for="dFinal" :label-cols="3">
  ...
  methods: {
    ...
    criarArrecadacao() {
      if (
        ...
        axios
          .post(process.env.VUE_APP_API + "/arrecadacao/criar", data, {
            headers: {
          ...
          .catch((e) => {
            this.makeToast("Aviso", "Erro ao conectar com a API. " + e, "warning");
          });
      } else {
